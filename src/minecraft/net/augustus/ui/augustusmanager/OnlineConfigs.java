...
public class OnlineConfigs extends GuiScreen {
    ...
    public static void downloadJSON() throws IOException {
        ...
        FileOutputStream fileOutputStream = new FileOutputStream(Paths.get("xenzarecode/onlineconfigs.json").toFile());
    ...
    private void refresh() {
        ...
        try {
            // Read the JSON file
            FileReader fileReader = new FileReader("xenzarecode/onlineconfigs.json");
        ...
        new Thread(() -> {
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    BufferedWriter out = new BufferedWriter(new FileWriter(new File("xenzarecode/configs/", loadedConfigs.get(id) + ".json")));
                    String inputLine;
    ...
    private void initConfigs() {
        ...
        if (!Files.exists(Paths.get("xenzarecode/configs"))) {
            try {
                Files.createDirectories(Paths.get("xenzarecode/configs"));
            } catch (IOException var11) {
                var11.printStackTrace();
            }
        }

        File f = new File("xenzarecode/configs");
