...
public class Fly extends Module {
   public StringValue mode = new StringValue(1, "Mode", this, "Vanilla", new String[]{"Vanilla", "Motion", "Collide", "AirJump", "Verus", "Verus2", "SkycaveBad", "Teleport", "FurtherTeleport", "Test", "SilentACAbuse", "Karhu", "FoxAC", "VulcanGlide", "Grim", "Packet"});
