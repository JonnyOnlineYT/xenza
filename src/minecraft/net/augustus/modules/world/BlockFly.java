...
public class BlockFly extends Module {
   ...
   public final StringValue towerMode = new StringValue(1234, "TowerMode", this, "None", new String[] {"None", "Vanilla", "LowHop", "FastJump", "NCP", "AAC"});
   ...
   public StringValue silentMode = new StringValue(1, "SilentMode", this, "Spoof", new String[]{"Switch", "Spoof", "None"});
   ...
   private void checkS32Packets() {
      try {
         ...
         for(Map.Entry<S32PacketConfirmTransaction, Long> set : transactions.entrySet()) {
            if(set.getValue() + 1000 < System.currentTimeMillis()) {
               //mc.theWorld.invalidateRegionAndSetBlock(set.getKey().getBlockPosition(), set.getKey().getBlockState());
               mc.thePlayer.sendQueue.handleConfirmTransaction(set.getKey());
               toremove = set.getKey();
            }
         }
      ...
      switch (towerMode.getSelected()) {
         ...
         case "NCP": {
            ...
            if (mc.thePlayer.posY % true <= 0.00153598D) {
               mc.thePlayer.setPosition(mc.thePlayer.posX, Math.floor(mc.thePlayer.posY), mc.thePlayer.posY);
   ...
   public boolean isTower2() {
      return mc.gameSettings.keyBindJump.pressed && ((!mc.gameSettings.keyBindLeft.pressed && !mc.gameSettings.keyBindRight.pressed && !mc.gameSettings.keyBindForward.pressed && !mc.gameSettings.keyBindBack.pressed) || towerMove.getBoolean());
   }
         ...
         if (this.playerYaw.getBoolean() && this.rayCast.getBoolean()) {
            ...
            if (this.rotateToBlock.getBoolean()) {
               if (this.correctSide.getBoolean()) {
                  ...
                  MovingObjectPosition objectPosition = mc.thePlayer.customRayTrace(4.5, 1.0F, this.rots[0], this.rots[1]);
                  if (objectPosition != null
                     ...
                     this.lastRots[0] = this.rots[0];
                     this.lastRots[1] = this.rots[1];
                     this.rots = RotationUtil.positionRotation(
                             (double) this.b.getX() + 0.5, (double) this.b.getY() + 0.5, (double) this.b.getZ() + 0.5, this.lastRots, yawSpeed, pitchSpeed, false
                     );
   ...
   public void onEventClick(EventClick eventClick) {
      ...
      if (this.shouldScaffold() && this.b != null) {
         ...
         if (!this.rayCast.getBoolean()) {
            ...
            if (flag && itemStack != null && this.spamClick.getBoolean() && mc.playerController.sendUseItem(mc.thePlayer, mc.theWorld, itemStack)) {
                  ...
                  case BLOCK:
                     if (objectPosition.getBlockPos().equalsBlockPos(this.b)) {
                        if (objectPosition.sideHit == EnumFacing.UP) {
                           if (!this.sameY.getBoolean() || mc.gameSettings.keyBindJump.isKeyDown() && Mouse.isButtonDown(1)) {
                              if (this.silentMode.getSelected().equals("Switch")) {
                                 mc.thePlayer.inventory.setCurrentItem(itemStack.getItem(), 0, false, false);
                              }
                              ...
                              if (mc.playerController
                                 .onPlayerRightClick(
                                    mc.thePlayer, mc.theWorld, itemStack, objectPosition.getBlockPos(), objectPosition.sideHit, objectPosition.hitVec
                                 )) {
                                 mc.thePlayer.swingItem();
                           ...
                           if ((this.shouldBuild() || !this.latestPlace.getBoolean() || this.latestPlace.getBoolean() && !this.latestRotate.getBoolean())
                              && mc.playerController
                                 .onPlayerRightClick(
                                    mc.thePlayer, mc.theWorld, itemStack, objectPosition.getBlockPos(), objectPosition.sideHit, objectPosition.hitVec
                                 )) {
   ...
   public void onEventSilentMove(EventSilentMove eventSilentMove) {
      ...
      if (this.startSneak.getBoolean()
         && (!this.startTimeHelper.reached(200L) || mc.thePlayer.motionX == 0.0 && mc.thePlayer.motionZ == 0.0 && mc.thePlayer.onGround)) {
         mc.thePlayer.movementInput.sneak = true;
      }
      ...
      if (this.sneak.getBoolean() && !mc.gameSettings.keyBindJump.isKeyDown()) {
         if (!this.sneakOnPlace.getBoolean()) {
            if (this.sneakDelayBool.getBoolean()) {
               if (this.sneakTimeHelper.reached((long)this.sneakDelay.getValue()) && mc.thePlayer.onGround && this.shouldSneak()) {
                  this.isSneakingTicks = 0;
                  this.sneakTimeHelper.reset();
               }
            } else if (this.buildForward()) {
               if ((double)this.blockCounter >= this.sneakBlocks.getValue() && mc.thePlayer.onGround && this.shouldSneak()) {
                  this.isSneakingTicks = 0;
               }
            } else if ((double)this.blockCounter >= this.sneakBlocksDiagonal.getValue() && mc.thePlayer.onGround && this.shouldSneak()) {
               this.isSneakingTicks = 0;
            }
            ...
            playerBlock = mc.theWorld
               .getBlockState(new BlockPos(mc.thePlayer.posX - mc.thePlayer.motionX, mc.thePlayer.posY - 0.5, mc.thePlayer.posZ - mc.thePlayer.motionZ))
               .getBlock();
      ...
      if (!this.isTower()) {
         if (this.rayCast.getBoolean()
            ...
            && MoveUtil.isMoving()
            && this.buildForward()
            && (!this.moonWalk.getBoolean() || !this.playerYaw.getBoolean())) {
         ...
         if (this.moonWalk.getBoolean()
            && this.playerYaw.getBoolean()
            && this.b != null
            && this.rayCast.getBoolean()
            && this.buildForward()
            && MoveUtil.isMoving()) {
   ...
   private float[] getRayCastRots() {
      ...
      if ((mc.thePlayer.motionX != 0.0 || mc.thePlayer.motionZ != 0.0 || !mc.thePlayer.onGround) && this.startTimeHelper.reached(200L)) {
   ...
   private boolean canPlace(float[] yawPitch) {
      ...
      if (m4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
         && BlockUtil.isValidBock(m4.getBlockPos())
         && m4.getBlockPos().equalsBlockPos(this.b)
   ...
   private BlockPos getPredictedBlockPos() {
      ...
      for(float i = Math.max(this.rots[1] - 30.0F, -90.0F); i < Math.min(this.rots[1] + 20.0F, 90.0F); i += 0.05F) {
         ...
         if (m4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
            && BlockUtil.isValidBock(m4.getBlockPos())
            && this.isNearbyBlockPos(m4.getBlockPos())
            && m4.sideHit != EnumFacing.DOWN
            && m4.sideHit != EnumFacing.UP) {
            pitchs.add(f[1]);
         }
   ...
   private float[] getPlayerYawRotation() {
      ...
      boolean godBridge = this.godBridge.getBoolean();
      float yaw = this.rots[0];
      float yawSpeed = MathHelper.clamp_float((float)(this.yawSpeed.getValue() + (double)RandomUtil.nextFloat(0.0F, 15.0F)), 0.0F, 180.0F);
      float pitchSpeed = MathHelper.clamp_float((float)(this.pitchSpeed.getValue() + (double)RandomUtil.nextFloat(0.0F, 15.0F)), 0.0F, 180.0F);
      if (this.isTower()) {
         ...
         if (objectPosition != null) {
            ...
            yaw = this.rotationUtil
               .rotateToYaw(
                  pitchSpeed,
                  this.rots,
                  moonWalk ? Augustus.getInstance().getYawPitchHelper().realYaw - 180.0F + 18.5F : godBridge ? Augustus.getInstance().getYawPitchHelper().realYaw - 180.0F + 45 : Augustus.getInstance().getYawPitchHelper().realYaw - 180.0F
               );
      ...
      yaw = this.rotationUtil
         .rotateToYaw(yawSpeed, this.rots[0], moonWalk ? Augustus.getInstance().getYawPitchHelper().realYaw - 180.0F + 18.5F : godBridge ? Augustus.getInstance().getYawPitchHelper().realYaw - 180.0F + 45 : realYaw - 180.0F);
      rotations[0] = yaw;
      if (this.shouldBuild()) {
         MovingObjectPosition m1 = RayTraceUtil.rayCast(1.0F, new float[]{rotations[0], rotations[1]});
         if (m1.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
            && BlockUtil.isValidBock(m1.getBlockPos())
            && this.isNearbyBlockPos(m1.getBlockPos())
            && m1.sideHit != EnumFacing.DOWN
            ...
            for(int yawLoops = 0; yawLoops < 180; ++yawLoops) {
               ...
               for(int pitchLoops = 0; pitchLoops < 25; ++pitchLoops) {
                  ...
                  if (m7.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
                     && BlockUtil.isValidBock(m7.getBlockPos())
                     && this.isNearbyBlockPos(m7.getBlockPos())
                     && m7.sideHit != EnumFacing.DOWN
                     && m7.sideHit != EnumFacing.UP) {
                  ...
                  if (m6.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
                     && BlockUtil.isValidBock(m6.getBlockPos())
                     && this.isNearbyBlockPos(m6.getBlockPos())
                     && m6.sideHit != EnumFacing.DOWN
                     && m6.sideHit != EnumFacing.UP) {
                  ...
                  if (m5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
                     && BlockUtil.isValidBock(m5.getBlockPos())
                     && this.isNearbyBlockPos(m5.getBlockPos())
                     && m5.sideHit != EnumFacing.DOWN
                     && m5.sideHit != EnumFacing.UP) {
      ...
      if (this.b == null) {
         ...
         if (enumFacing != null) {
            if (enumFacing == EnumFacing.UP) {
               ...
               max = new Vec3(
                  (double)this.b.getX() + block.getBlockBoundsMaxX() - add,
               ...
               max = new Vec3(
                       this.b.getX(), (double)this.b.getY() + block.getBlockBoundsMaxY() - add, (double)this.b.getZ() + block.getBlockBoundsMaxZ() - add
               );
            } else if (enumFacing == EnumFacing.EAST) {
               min = new Vec3((double)this.b.getX() + block.getBlockBoundsMaxX(), (double)this.b.getY() + add, (double)this.b.getZ() + add);
               max = new Vec3(
                  (double)this.b.getX() + block.getBlockBoundsMaxX(),
               ...
               max = new Vec3(
                  (double)this.b.getX() + block.getBlockBoundsMaxX() - add, (double)this.b.getY() + block.getBlockBoundsMaxY() - add, this.b.getZ()
               );
            } else if (enumFacing == EnumFacing.DOWN) {
               min = new Vec3((double)this.b.getX() + add, this.b.getY(), (double)this.b.getZ() + add);
               max = new Vec3(
                  (double)this.b.getX() + block.getBlockBoundsMaxX() - add, this.b.getY(), (double)this.b.getZ() + block.getBlockBoundsMaxZ() - add
               );
            }
         }
...
//         return new BlockPos(mc.thePlayer.posX + forward[0], mc.thePlayer.posY - 1.0, mc.thePlayer.posZ + forward[1]);
         BlockPos playerPos = new BlockPos(mc.thePlayer.posX + forward[0], mc.thePlayer.posY - 1.0, mc.thePlayer.posZ + forward[1]);
         ArrayList<Vec3> positions = new ArrayList<>();
         HashMap<Vec3, BlockPos> hashMap = new HashMap<>();

         for (int x = (int) (playerPos.getX() - (expand.getValue() + 5)); x <= playerPos.getX() + expand.getValue() + 5; ++x) {
            for (int y = playerPos.getY() - 1; y <= playerPos.getY(); ++y) {
               for (int z = (int) (playerPos.getZ() - (expand.getValue() + 5)); z <= playerPos.getZ() + expand.getValue() + 5; ++z) {
                  if (BlockUtil.isValidBock(new BlockPos(x, y, z))) {
                     BlockPos blockPos = new BlockPos(x, y, z);
                     Block block = mc.theWorld.getBlockState(blockPos).getBlock();
                     double ex = MathHelper.clamp_double(mc.thePlayer.posX, blockPos.getX(), (double) blockPos.getX() + block.getBlockBoundsMaxX());
         ...
         if (!positions.isEmpty()) {
            positions.sort(Comparator.comparingDouble(this::getBestBlock));
            return this.isTower() && (double) hashMap.get(positions.get(0)).getY() != mc.thePlayer.posY - 1.5
                    ? new BlockPos(mc.thePlayer.posX + forward[0], mc.thePlayer.posY - 1.5, mc.thePlayer.posZ + forward[1])
                    : hashMap.get(positions.get(0));
         }
      }
      return null;
   ...
   private boolean shouldBuild() {
      /*
      boolean yes = false;
      if (placeTimer.reached(placeDelay)) {
         yes = true;
         placeDelay = RandomUtil.nextInt((int) minDelay.getValue(), (int) maxDelay.getValue());
         placeTimer.reset();
      }
      */
      if (this.latestRotate.getBoolean() && this.rayCast.getBoolean()) {
         ...
         return x > maX || x < miX || z > maZ || z < miZ || this.predict.getBoolean() && this.rayCast.getBoolean() && this.prediction()/* && yes*/;
      } else {
         double[] ichVercrafteDasAllesNichtMehr = teleportForward(expand.getValue());
         BlockPos playerPos = new BlockPos(mc.thePlayer.posX + ichVercrafteDasAllesNichtMehr[0], mc.thePlayer.posY - 0.5, mc.thePlayer.posZ + ichVercrafteDasAllesNichtMehr[1]);
   ...
   private boolean shouldSneak() {
      if (this.latestRotate.getBoolean() && this.rayCast.getBoolean()) {
         ...
         Block playerBlock = mc.theWorld
            .getBlockState(
               new BlockPos(mc.thePlayer.posX + mc.thePlayer.posX - this.xyz[0], mc.thePlayer.posY - 0.5, mc.thePlayer.posZ + mc.thePlayer.posZ - this.xyz[2])
            )
            .getBlock();
         this.xyz = new double[]{mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ};
